  ...
  sections: [
    {
      ...
      title: "소개",
      paragraphs: [
        "20여 개 글로벌 공급사를 연동하는 호텔 예약 시스템에서 응답 속도와 대용량 배치를 개선해온 백엔드 개발자입니다. 800만 건 규모 콘텐츠 동기화 배치를 유량 제어로 3주에서 5일로 줄이고 140여 대 IDC 서버의 실시간 관제 체계를 구축했습니다.",
          ...
          projects: [
            ...
            },
            {
              ...
              achievements: [
                {
                  label: "문제",
                  text: "요금 조회마다 20여 개 공급사에 fanout 후 최저가를 연산하는 구조라 단일 요청 비용이 크고, 공급사당 최대 265만 개 콘텐츠 동기화가 운영과 API 한도를 공유해 배치가 3주씩 걸렸습니다.",
                },
                {
                  label: "해결",
                ...
                {
                  label: "성과",
                  text: "800만 건 API 배치 3주 → 5일(실효 동시성 2 → 5.66, 실패율 0.007%). 140여 대 IDC 서버 실시간 관제 페이지를 만들어 OOM·힙 이상·공격 트래픽을 탐지·조치. 요금 조회 응답 시간 ◻ms → ◻ms",
                },
              ],
            },
          ],
